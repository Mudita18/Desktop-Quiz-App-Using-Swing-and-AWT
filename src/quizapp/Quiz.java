...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        lifeline.setBounds(500,590,300,35);
        ...
        submit.setBounds(1000,590,100,35);
    ...
    public void paint(Graphics g){
        ...
        try{
            Thread.sleep(1000);//sleep is a method in multithreading which takes  parameter in milisecond and 1 sec=1000ms.
            repaint();
        }
        catch(Exception e){
            e.printStackTrace();
        ...
        if(ans_given == 1){
            ...
            if(count==9){//if user didnt click submit button after last question.
                if(groupoptions.getSelection() == null){
                    user_answers[count][0] = "";
                }
                else{
